	...
	uvm_analysis_port #(processor_transaction) aport;     
	 ...
	 fork
	   forever begin
		...
		// [BPU] branch prediction signals
		pros_trans.pred_taken  = processor_vif.monitor_if_mp.monitor_cb.pred_taken;
		pros_trans.pred_target = processor_vif.monitor_if_mp.monitor_cb.pred_target;
		pros_trans.actual_taken= processor_vif.monitor_if_mp.monitor_cb.actual_taken;
		pros_trans.flush       = processor_vif.monitor_if_mp.monitor_cb.flush;
		pros_trans.mispredicted= processor_vif.monitor_if_mp.monitor_cb.mispredicted;
		pros_trans.btb_hit     = processor_vif.monitor_if_mp.monitor_cb.btb_hit;
		pros_trans.bht_state   = processor_vif.monitor_if_mp.monitor_cb.bht_state;
